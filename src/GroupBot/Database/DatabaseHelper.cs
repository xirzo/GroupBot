...
";
    ...
    public long CreateListAndShuffle(string listName)
    {
        ...
        var listId = CreateList(listName);
        ...
        using (var insertCommand = new SQLiteCommand(insertMemberQuery, connection))
        {
            ...
            var userIdParam = insertCommand.Parameters.Add("@user_id", DbType.Int32);
            var positionParam = insertCommand.Parameters.Add("@position", DbType.Int32);
